# Original code source and explanation:
# https://cppsecrets.com/users/1108979711510497121461151049710464115111109971051219746101100117/Python-Round-Robin-Scheduling-Algorithm-with-Different-Arrival-Time.php
class RoundRobin:
    ...
    def processData(self, no_of_processes):
        ...
        time_slice = int(input("Enter Time Slice (Quantum Time): "))
